...
Player.prototype.getCard = function(stack) {
    this.hand.push(stack.dealCard());
};
...
Stack.prototype.drawCard = function(n) {
...
cardImg0.src = 'images/cardback.gif';

var cardImg1 = new Image();
cardImg1.src = 'images/jack.gif';

var cardImg2 = new Image();
cardImg2.src = 'images/queen.gif';

var cardImg3 = new Image();
cardImg3.src = 'images/king.gif';

Card.prototype.createDomNode = function() {
    // TODO see if indexNode is needed
    var cardNode, frontNode,  spotNode, tempNode, textNode;
